...
Currently working as a Software Engineer at [PhonePe](https://www.phonepe.com/).

Before joining PhonePe, I worked as a Software Engineer at [BitGo](https://www.bitgo.com/), primarily on the backend. Prior to that, I worked as a Software Development Engineer at [MediBuddy](https://www.medibuddy.in/), a leading healthcare technology platform. There, I developed solutions that improved healthcare access for millions. Before that, I contributed to the digital savings account team at [Freecharge](https://freecharge.in/), enhancing user experiences and streamlining financial services.
